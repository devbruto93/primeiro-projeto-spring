...
import com.douglas.course.entities.*;
import com.douglas.course.entities.enums.OrderStatus;
import com.douglas.course.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o2 = new Order(null, Instant.parse("2019-07-21T:03:42:10Z"), OrderStatus.WAITING_PAYMENT, u2);
